...
#Data lecture
#Geopackage & Raster
vec= gpd.read_file(r"/home/duilio/Desktop/mocho_50m_bandas/mocho_bandas_50m_porcuenca_32719_3.gpkg")
...
for i in range(vec["geometry"].shape[0]):    
    ...
    #print(values_mask)   
    #Clear 
    dhdt_pnd=(np.mean(values_mask)*area_pol/(vec["AREA_Km2"][i]*(10**6)))
    #print(dhdt_pnd)
    #Saving Vectors
    poly.append(iout)
...
output.to_csv('dhdt_hugonnet.csv', index=False, encoding='utf-8')
